...
// Query to get all movie IDs from the user's favorites list
$sql = "SELECT m.MovieID 
        FROM Movies m
        JOIN FavoriteMovies_has_Movies f ON m.MovieID = f.Movies_MovieID
        WHERE f.FavoriteMovies_FavoriteListID = '$user_id'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo json_encode(["message" => "No movies found in your favorites."]);
}
?>
